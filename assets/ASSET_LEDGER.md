...
| `ui/vfx/wildguard-signature-frames-v2.png` | Built-in OpenAI image generation, border-connected chroma cleanup, 768px derivative | 2026-07-13 | None | `94f3edc4a590b741d538ac383830d2ee379e7ecabb9dc687b917ceaa44f8cdd2` | Transparent 4×4 animated signature-VFX sheet: four-frame Fox Swipe, Benny Trample, Gracie Spit, and combat/shield impact sequences; source `exec-5bbf37b3-5f48-4f9d-afd2-9f2ae8d4a4ed.png`; exact prompt and cleanup record in `docs/release/v1-1-visual-overhaul-prompts.md` |
| `ui/vfx/wildguard-world-frames-v2.png` | Built-in OpenAI image generation, border-connected chroma cleanup, 768px derivative | 2026-07-13 | None | `633e69d99dba94e25ed0371299a7675313ca54f9f3131c5993e26d7a9ca040ce` | Transparent 4×4 animated world-VFX sheet: four-frame XP/reward, hostile thorn, fluffy shield, Bomb, Magnet, Food, and master-XP sequences; source `exec-73ab216b-dec0-4bf3-a082-a6ff9640e17a.png`; exact prompt and cleanup record in `docs/release/v1-1-visual-overhaul-prompts.md` |
| `ui/vfx/wildguard-fields-frames-v3.png` | Built-in OpenAI image generation, border-connected chroma cleanup, 768px derivative | 2026-07-13 | None | `b60f315a2c19a94e80e5552580debb85c9290cc7f8e0ae4d22a9231314399876` | Transparent 4×4 animated field-VFX sheet: Puffer Pulse, Gecko/Razorstep pad, Skunk Brush, and Royal Stinkcloud; source `exec-82c42a26-0fb8-4a42-9992-97031bdfaedf.png`; exact prompt and cleanup record in `docs/release/v1-1-visual-overhaul-prompts.md` |
| `ui/vfx/wildguard-melee-frames-v3.png` | Built-in OpenAI image generation, border-connected chroma cleanup, 768px derivative | 2026-07-13 | None | `edf083bee7ef1c5589ae2c3657e586f1c596e16b52de96bdf6dd07c36002e573` | Transparent 4×4 animated melee-VFX sheet: Mantis Scythes, Crab Pincers, Armadillo Greaves, and Meteor Mauler; source `exec-1a8b8a70-299e-4010-86e1-ee505fcc3fc1.png`; exact prompt and cleanup record in `docs/release/v1-1-visual-overhaul-prompts.md` |
| `ui/vfx/wildguard-projectile-frames-v3.png` | Built-in OpenAI image generation, border-connected chroma cleanup, 768px derivative | 2026-07-13 | None | `e8a6648d54f46cf77db8ba7e0389f16a69abbd34fc510c30e3cbd7cdefa26071` | Transparent 4×4 animated projectile-VFX sheet: Porcupine Quills, Owl Pinions, Thornstorm Mantle, and Thunderbug Dynamo; source `exec-44be7a61-c89c-4598-aceb-4606de2d5ca8.png`; exact prompt and cleanup record in `docs/release/v1-1-visual-overhaul-prompts.md` |
| `ui/vfx/wildguard-aura-frames-v3.png` | Built-in OpenAI image generation, border-connected chroma cleanup, 768px derivative | 2026-07-13 | None | `e9073694299888af94d056cfac1d30bbc8024a2861e30ef3dad5456ae93ca757` | Transparent 4×4 animated aura-VFX sheet: Firefly Colony, Monarch Brood, Bat Ears, and Midnight Radar; source `exec-cbe0eee1-eb17-44dc-95e9-e9f958ea4170.png`; exact prompt and cleanup record in `docs/release/v1-1-visual-overhaul-prompts.md` |

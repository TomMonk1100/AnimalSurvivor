...
Greg begins with Auto-Fire and can acquire four more attack families:
...
4. **Attack choices.** Pick at least two different attacks if offered. Can you
   tell what Quills, Puffer, Coil, and Firefly are meant to do from their cards
   and their first use? Which feels most satisfying, weak, or confusing?
